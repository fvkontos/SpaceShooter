...
class WaterEditorUtility
{
    ...
    internal static UnityEngine.Object GetMaterialTexture(string v, object sharedMaterial)
    {
        throw new NotImplementedException();
    }

    internal static void SetMaterialTexture(string v, Texture texture, object sharedMaterial)
    {
        throw new NotImplementedException();
    }
    /*
